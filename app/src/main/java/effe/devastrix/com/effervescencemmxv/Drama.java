...
public class Drama extends AppCompatActivity implements  TextWatcher, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList = (JazzyListView)findViewById(R.id.listDrama);
        shad = (View) findViewById(R.id.shadow);

        mList.setTransitionEffect(new SlideInEffect());


        mList.addHeaderView(Drama.this.getLayoutInflater().inflate(R.layout.listview_header,null));

        //Add events in this array
        events_1 = new String[] {"Director's Cut", "Double Trouble", "Innovation", "Bindaas Bol", "Tongues on fire","Kahaani"};

        images = new int[] {R.mipmap.c_drama, R.mipmap.c_drama, R.mipmap.c_drama, R.mipmap.c_drama, R.mipmap.c_drama, R.mipmap.c_drama, };

        timing = new String[] {"All day","Sat, 15:00","Fri, 22:00","Fri, 13:00","Sat, 15:00","All day"};

        intents = new String[]{"DIR", "DOU","INN","BIN",
                "TON","KAH","PSY","PSY",
                "PSY","PSY","PSY","PSY",
                "PSY","PSY","PSY","PSY"};
...
//        searchContent.getBackground().setColorFilter(getResources().getColor(R.color.whitE), PorterDuff.Mode.SRC_ATOP);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_drama, menu);
        return true;
    }
