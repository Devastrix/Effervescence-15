...
public class Fineart extends AppCompatActivity implements  TextWatcher, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fineart);
        ...
        mList = (JazzyListView)findViewById(R.id.listFinearts);
        shad = (View) findViewById(R.id.shadow);

        mList.setTransitionEffect(new SlideInEffect());


        mList.addHeaderView(Fineart.this.getLayoutInflater().inflate(R.layout.listview_header,null));

        //Add events in this array
        events_1 = new String[] {"Graffiti", "Toon Con", "The Sketcher", "Story Pic"};

        images = new int[] {R.mipmap.c_fine, R.mipmap.c_fine, R.mipmap.c_fine, R.mipmap.c_fine, };

        timing = new String[] {"Fri, 11:00","Fri, 16:00","","Sat, 12:00"};

        intents = new String[]{"GRA", "TOO","THE","STO",
                "PSY","PSY","PSY","PSY",
                "PSY","PSY","PSY","PSY",
                "PSY","PSY","PSY","PSY"};
