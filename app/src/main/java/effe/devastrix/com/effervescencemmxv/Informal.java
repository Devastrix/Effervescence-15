...
public class Informal extends AppCompatActivity implements  TextWatcher, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList = (JazzyListView)findViewById(R.id.listInf);
        shad = (View) findViewById(R.id.shadow);

        mList.setTransitionEffect(new SlideInEffect());


        mList.addHeaderView(Informal.this.getLayoutInflater().inflate(R.layout.listview_header,null));

        //Add events in this array
        events_1 = new String[] {"Treasure Hunt","Lights!Camera!Action!", "Gully Cricket", "Roadies",
                "Gamer's Asylum","Blind Date","Anime Quiz","TV Series Quiz",
             "China Town","Cricket Quiz","Bollywood Tambola","Balloon Fight","Tug of War","Cinemamash","Street Soccer",
            "Paanipuri Junction","Book Cricket","Pillow Fight","Photobooth","Ranneeti","Intuizone","AdMania",
                "Arm Wrestling","Half Court Basketball","B Quiz","Silverscreen"};

        images = new int[] {R.mipmap.c_informal,R.mipmap.c_informal,R.mipmap.c_informal,R.mipmap.c_informal,R.mipmap.c_informal,
                R.mipmap.c_informal,R.mipmap.c_informal,R.mipmap.c_informal,R.mipmap.c_informal,R.mipmap.c_informal,R.mipmap.c_informal,
                R.mipmap.c_informal,R.mipmap.c_informal,R.mipmap.c_informal,R.mipmap.c_informal,R.mipmap.c_informal,R.mipmap.c_informal,
                R.mipmap.c_informal,R.mipmap.c_informal,R.mipmap.c_informal,R.mipmap.c_informal,R.mipmap.c_informal,R.mipmap.c_informal,
                R.mipmap.c_informal,R.mipmap.c_informal,R.mipmap.c_informal,R.mipmap.c_informal,R.mipmap.c_informal,R.mipmap.c_informal,};

        timing = new String[] {"Thu, 21:00","Fri, 15:00","Fri, 09:00","Fri, 10:00","Fri, 12:00","Fri, 16:00","Sat, 12:00",
        "Sat, 10:00","Fri, 00:00","Sun, 13:00","Sun, 11:00","Sat, 11:00","Sun, 11:00","All day","Fri, 15:00","Sun, 12:00","Sat, 15:00","Fri, 16:30","All day",
        "Fri, 13:00","Sun, 11:00","Sat, 14:00","Sun, 13:00","Sat, 14:00","Sat, 14:00","Thu, 19:30"};

        intents = new String[]{"TRE","LIG", "GUL","ROA","GAM",
                "BLI","ANQ","TVQ","CHI",
                "CRQ","BOL","BAL","TUG",
                "CIN","STR","PAN","BOO",
                "PIL","PHO","RAN","INT",
...
//        searchContent.getBackground().setColorFilter(getResources().getColor(R.color.whitE), PorterDuff.Mode.SRC_ATOP);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_informal, menu);
        return true;
    }
