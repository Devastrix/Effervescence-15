...
public class Music extends AppCompatActivity implements  TextWatcher, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
         ...
         mList = (JazzyListView)findViewById(R.id.listMusic);
        shad = (View) findViewById(R.id.shadow);

        mList.setTransitionEffect(new SlideInEffect());


        mList.addHeaderView(Music.this.getLayoutInflater().inflate(R.layout.listview_header,null));

        //Add events in this array
        events_1 = new String[] {"Psychadelia" ,"Unplugged" ,"Melodieux", "Antakshiri", "Incendiary"};

        images = new int[] {R.mipmap.c_music, R.mipmap.c_music, R.mipmap.c_music, R.mipmap.c_music, R.mipmap.c_music,R.mipmap.music };

        timing = new String[] {"Fri, 18:00","Sun, 15:00","Sat, 12:00","Fri, 12:00", "Sat, 20:30"};

        intents = new String[]{"PSY","UNP","KAR",
                "ANT","INC"};
