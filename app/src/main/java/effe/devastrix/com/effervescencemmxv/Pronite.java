...
public class Pronite extends AppCompatActivity implements  TextWatcher, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList = (JazzyListView)findViewById(R.id.listPro);
        shad = (View) findViewById(R.id.shadow);

        mList.setTransitionEffect(new SlideInEffect());


        mList.addHeaderView(Pronite.this.getLayoutInflater().inflate(R.layout.listview_header,null));

        //Add events in this array
        events_1 = new String[] {"Psychadelia", "Incendiary", "Karaoke", "Melodiux"};

        images = new int[] {R.mipmap.c_informal, R.mipmap.c_informal,R.mipmap.c_informal,R.mipmap.c_informal,R.mipmap.c_informal,};

        timing = new String[] {"4:30 PM", "10:30 PM", "10:30 AM", "11:00 AM", "10:30 AM"};

        intents = new String[]{"eve", "eve","eve","eve",
                "PSY","PSY","PSY","PSY",
                "PSY","PSY","PSY","PSY",
                "PSY","PSY","PSY","PSY"};
...
//        searchContent.getBackground().setColorFilter(getResources().getColor(R.color.whitE), PorterDuff.Mode.SRC_ATOP);
    ...
    public void initList(String[] eventsArray, int[] imagesList, String[] timingList, String[] intentsList) {
        if(eventsArray.length != 0) {
            ...
            for(int i = 0; i < eventsArray.length; i++) {
                ...
                candy.put("intent", "effe.devastrix.com.effervescencemmxv."+intentsList[i].trim());
                eventList.add(candy);
            }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_pronite, menu);
        return true;
    }
