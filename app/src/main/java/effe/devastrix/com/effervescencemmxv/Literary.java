...
public class Literary extends AppCompatActivity implements  TextWatcher, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList = (JazzyListView)findViewById(R.id.listLit);
        shad = (View) findViewById(R.id.shadow);

        mList.setTransitionEffect(new SlideInEffect());


        mList.addHeaderView(Literary.this.getLayoutInflater().inflate(R.layout.listview_header,null));

        //Add events in this array
        events_1 = new String[] {"MUN", "Cognoscencia", "Feathers", "Dumb Charades"};

        images = new int[] {R.mipmap.c_lit, R.mipmap.c_lit, R.mipmap.c_lit, R.mipmap.c_lit, };

        timing = new String[] {"Thu, 20:00","Sun, 10:00","Sun, 12:00","Fri, 10:00"};

        intents = new String[]{"MUN", "COG","FEA","DUM",
                "DUM","PSY","PSY","PSY",
                "PSY","PSY","PSY","PSY",
                "PSY","PSY","PSY","PSY"};
...
//        searchContent.getBackground().setColorFilter(getResources().getColor(R.color.whitE), PorterDuff.Mode.SRC_ATOP);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_literary, menu);
        return true;
    }
