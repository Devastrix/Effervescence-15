...
public class Ams extends AppCompatActivity implements  TextWatcher, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList = (JazzyListView)findViewById(R.id.listams);
        shad = (View) findViewById(R.id.shadow);

        mList.setTransitionEffect(new SlideInEffect());


        mList.addHeaderView(Ams.this.getLayoutInflater().inflate(R.layout.listview_header,null));

        //Add events in this array
        events_1 = new String[] {"Tasveer", "Selfie Time", "Snapshot", };

        images = new int[] {R.mipmap.c_ams,R.mipmap.c_ams,R.mipmap.c_ams,};

        timing = new String[] {"All day", "All day", "All day",};

        intents = new String[]{"TAS", "SEL","SNA",
                "PSY","PSY","PSY","PSY",
                };
...
//        searchContent.getBackground().setColorFilter(getResources().getColor(R.color.whitE), PorterDuff.Mode.SRC_ATOP);
        ...
        activityName.setText("Photography");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_ams, menu);
        return true;
    }
