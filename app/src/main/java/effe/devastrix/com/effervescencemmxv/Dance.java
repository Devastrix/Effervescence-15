...
public class Dance extends AppCompatActivity implements  TextWatcher, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList = (JazzyListView)findViewById(R.id.listDance);
        shad = (View) findViewById(R.id.shadow);

        mList.setTransitionEffect(new SlideInEffect());


        mList.addHeaderView(Dance.this.getLayoutInflater().inflate(R.layout.listview_header,null));

        //Add events in this array
        events_1 = new String[] {"La Frenze", "Carpe Diem", "Footloose", "Show Off","Dance Charades"};

        images = new int[] {R.mipmap.c_dance,R.mipmap.c_dance,R.mipmap.c_dance,R.mipmap.c_dance,R.mipmap.c_dance,};

        timing = new String[] {"Fri, 20:00","Fri, 21:00","Sat, 18:00","All  day","Fri, 15:00"};

        intents = new String[]{"LAF", "CAD","FOO","SHO",
                "DAN","PSY","PSY","PSY",
                "PSY","PSY","PSY","PSY",
                "PSY","PSY","PSY","PSY"};
...
//        searchContent.getBackground().setColorFilter(getResources().getColor(R.color.whitE), PorterDuff.Mode.SRC_ATOP);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_dance, menu);
        return true;
    }
